...
const AddInviteePage = () => {
  const [invitees, setInvitees] = useState<InviteeModel[]>([]);
  ...
  return (
    ...
    >
      ...
      <div className="item-center mx-auto mb-8 flex items-center justify-center rounded-lg p-8 text-white shadow-md md:w-96 dark:border-gray-700 dark:bg-gray-800 ">
